        ...
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white overflow-hidden h-screen w-full z-50 absolute'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                <div className="navlink flex w-full justify-between p-3 items-start">
                    ...
                    <div onClick={() => {
                        setNavOpen(false)
                    }} className='h-15 w-29 relative cursor-pointer'>
                        <div className='h-40 w-0.5 -rotate-45 origin-top absolute bg-[#D3FD50]'></div>
                        <div className='h-40 w-0.5 right-0 rotate-45 origin-top absolute bg-[#D3FD50]'></div>
                    </div>
                </div>
                <div className=' py-36'>
