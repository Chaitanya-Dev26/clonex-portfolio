    ...
    return (
        <div className='z-50 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div 
                ...
                className='l:h-13.5 h-11 bg-black relative  lg:w-[15.5vw] w-47 cursor-pointer'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full lg:px-9.5 px-8 flex flex-col justify-center items-end gap-1 group'>
