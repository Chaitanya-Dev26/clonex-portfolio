    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div 
                ...
                className='h-13.5 bg-black relative  w-[15.5vw] '>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full px-9.5 flex flex-col justify-center items-end gap-1'>
                    <div className="w-12.5 h-0.5 bg-white"></div>
